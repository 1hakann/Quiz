...
class QuestionController extends Controller
{
    ...
    {
        $quiz = Quiz::whereId($id)->with('questions')->first() ?? abort(404, 'Soru bulunamadı');
    ...
    public function update(QuestionUpdateRequest $request, $quiz_id, $question_id)
    {
        ...
        return redirect()->route('questions.index',$quiz_id)->withSuccess('Soru başarıyla güncelleştirildi');
    }
